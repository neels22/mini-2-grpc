#!/usr/bin/env python3
"""
Process C - Team Green Worker Server
Worker process that processes queries for Team Green data subset
"""
...
class FireQueryServiceImpl(fire_service_pb2_grpc.FireQueryServiceServicer):
    """Implementation of FireQueryService for Process C (Team Green Worker)"""
    ...
    def __init__(self, config):
        ...
        # TODO: Initialize FireColumnModel with Team Green data subset
        # This process holds a non-overlapping subset of Team Green's data
    ...
    def InternalQuery(self, request, context):
        """
        Handle internal queries from team leader (Process B)
        ...
        # TODO: Query local FireColumnModel data for Team Green subset
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print("Usage: python server_c.py <config_file>")
        print("Example: python server_c.py ../configs/process_c.json")
        sys.exit(1)
